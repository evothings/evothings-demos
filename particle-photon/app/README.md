**Note**: This application is a modified version of [platzhersh](http://platzh1rsch.ch) *pacman-canvas*. Some files has been removed from the repository. If you are interested in the original commit you will find it [here](https://github.com/platzhersh/pacman-canvas/tree/3c24c7a995b1e329c5849ac24421eedfc1d70474). 
